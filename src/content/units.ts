...
const u10: Unit = {
  ...
  exercises: [
    ...vocabDrills("u10", ["gadal", "giddel", "higdil", "lamad", "limmed"]),
    {
      ...
      rootId: "גדל",
      forms: [
        { hebrew: "גָּדַל", translit: "gāḏal", binyan: "qal", gloss: "he was great" },
        { hebrew: "גִּדֵּל", translit: "giddēl", binyan: "piel", gloss: "he raised, brought up" },
        { hebrew: "הִגְדִּיל", translit: "hiḡdîl", binyan: "hiphil", gloss: "he magnified" },
      ],
    ...
    },
    {
      ...
      rootId: "למד",
      forms: [
        { hebrew: "לָמַד", translit: "lāmaḏ", binyan: "qal", gloss: "he learned" },
        { hebrew: "לִמַּד", translit: "limmaḏ", binyan: "piel", gloss: "he taught" },
      ],
